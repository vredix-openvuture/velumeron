...
init_user_settings() {
    ...
    # Skeleton creation is delegated to the GUI bridge so there is exactly
    # one canonical skeleton definition (markers, sections, defaults).
    python3 "$VELUMERON_DIR/assets/scripts/user-settings-io.py" init >/dev/null
