...
_vtl_wallpaper_dir() {
    ...
    local gs="$VUTURELAND_USER_DIR/gui/settings.json"
...
WALLPAPER_DIR_H="$(_vtl_wallpaper_dir wallpaper_dir_hor "$VUTURELAND_DIR/assets/wallpaper/horizontal")"
WALLPAPER_DIR_V="$(_vtl_wallpaper_dir wallpaper_dir_ver "$VUTURELAND_DIR/assets/wallpaper/vertical")"
