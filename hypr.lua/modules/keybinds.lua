...
hl.define_submap("window", function()
    ...
    hl.bind(MOD .. " + SHIFT + slash", hl.dsp.exec_cmd(VTL_DIR .. "/bin/vutureland --keybind-help window"))
    hl.bind("ESCAPE", exit_submap)
    hl.bind("RETURN", exit_submap)
end)
...
hl.define_submap("apps", function()
    ...
    hl.bind(MOD .. " + SPACE", function() launch_and_exit(launcher) end)
    hl.bind(MOD .. " + SHIFT + slash", hl.dsp.exec_cmd(VTL_DIR .. "/bin/vutureland --keybind-help apps"))
    hl.bind("ESCAPE", exit_submap)
    hl.bind("RETURN", exit_submap)
end)
...
hl.define_submap("system", function()
    ...
    hl.bind(MOD .. " + SHIFT + slash", hl.dsp.exec_cmd(VTL_DIR .. "/bin/vutureland --keybind-help system"))
    hl.bind("ESCAPE", exit_submap)
    hl.bind("RETURN", exit_submap)
end)
