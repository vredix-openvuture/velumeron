...
Item {
    ...
    Flickable {
        ...
        CardColumns {
            ...
            // The page's lead-in. It carries its sentence ON the card: a card with a heading and
            // nothing under it is a card-shaped hole, and this one's whole job is that sentence.
            Card {
                CardLabel { text: "INTEGRATIONS" }
                SubLabel {
                    width: parent.width
                    text: "Give external tools the velumeron look. Switching one on moves any config "
                        + "you already have safely aside (or edits it after a backup) — switch it "
                        + "back off and your original returns untouched."
                }
            }
