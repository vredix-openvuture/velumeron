...
Item {
    ...
    Row {
        ...
        Switch { on: root.powered; onToggled: root.run("bluetoothctl power " + (root.powered ? "off" : "on"), "") }
    }
    ...
    Flickable {
        ...
        Column {
            ...
            Column {
                ...
                FieldLabel { text: root.scanning ? "AVAILABLE — scanning…" : "AVAILABLE" }
